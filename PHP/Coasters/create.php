   ...
   // $input_coasterID = trim($_POST["coasterID"]);
    ...
    if(empty($coaster_name_err) && empty($height_err) && empty($speed_err) && empty($coasterID_err)
        ...
        if($stmt = mysqli_prepare($link, $sql)){
            ...
            mysqli_stmt_bind_param($stmt, "siiiisis", $param_name, $param_height,
                $param_speed, $param_coasterID, $param_year_opened, $param_location, $param_parkID, $param_manufacturer);
